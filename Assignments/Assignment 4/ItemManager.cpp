...
ItemManager::ItemManager (const string& game_name) {
	...
	Location locationC(7);
	Location locationK(13);
	Location locationT(19);
	Location locationB(22);
	Location locationM(37);
	Location locationP(52);
	Location locationD(53);
	Location locationR(58);
